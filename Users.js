...
// 1. Listado de todos los usuarios con solo los nombress, apellidos y edad, que tengan 20 años de edad.
db.users.find({ edad: 20 }, { nombress: 1, apellidos: 1, edad: 1 })
...
// 14. Listar todos los usuarios que su nombres inicie con "a" o "A".
